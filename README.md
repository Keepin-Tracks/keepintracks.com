...
```shell
git clone https://github.com/SimpleOpenSource/KeepinTracks
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/KeepinTracks/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://SimpleOpenSource.github.io/KeepinTracks'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/SimpleOpenSource/KeepinTracks
  - link: https://github.com/SimpleOpenSource/KeepinTracks#readme
...
`https://SimpleOpenSource.github.io/KeepinTracks`